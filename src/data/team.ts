...
export const domains: Domain[] = [
  ...
  { id: "robotics", label: "机器人", en: "ROBOTICS", seats: 2, weight: 52, core: true },
  { id: "quantum", label: "量子计算", en: "QUANTUM", seats: 1, weight: 32, core: true },
  { id: "semiconductor", label: "半导体", en: "SEMICONDUCTORS", seats: 1, weight: 40, core: true },
  ...
  { id: "security", label: "网络安全", en: "CYBERSECURITY", seats: 2, weight: 60, core: true },
...
export const openings: Opening[] = [
  ...
  { kind: "opening", seat: "AI 基础设施工程师", field: "ai", place: "远程 / 全球", focus: "分布式训练 · 推理优化", status: "招募中" },
  { kind: "opening", seat: "生物科技创始人", field: "bio", place: "远程 / 全球", focus: "合成生物 · 精准诊断", status: "招募中" },
  { kind: "opening", seat: "精准医疗数据科学家", field: "bio", place: "远程 / 全球", focus: "基因组学 · 临床数据建模", status: "招募中" },
  { kind: "opening", seat: "航空航天工程师", field: "aero", place: "远程 / 全球", focus: "新型推进 · 飞行器制造", status: "招募中" },
  { kind: "opening", seat: "飞控软件工程师", field: "aero", place: "远程 / 全球", focus: "自主导航 · 飞控系统", status: "招募中" },
  { kind: "opening", seat: "海洋机器人专家", field: "ocean", place: "远程 / 全球", focus: "水下机器人 · 海洋观测", status: "招募中" },
  { kind: "opening", seat: "海洋数据科学家", field: "ocean", place: "远程 / 全球", focus: "海洋观测网络 · 传感器融合", status: "招募中" },
  { kind: "opening", seat: "先进材料科学家", field: "materials", place: "远程 / 全球", focus: "超材料 · 先进制造", status: "招募中" },
  { kind: "opening", seat: "材料工艺工程师", field: "materials", place: "远程 / 全球", focus: "复合材料 · 规模化制造", status: "招募中" },
  { kind: "opening", seat: "数字医疗创始人", field: "health", place: "远程 / 全球", focus: "数字医疗 · 临床智能", status: "招募中" },
  { kind: "opening", seat: "医疗器械工程师", field: "health", place: "远程 / 全球", focus: "可穿戴设备 · 临床验证", status: "招募中" },
  { kind: "opening", seat: "机器人系统工程师", field: "robotics", place: "远程 / 全球", focus: "具身智能 · 感知与控制", status: "招募中" },
  { kind: "opening", seat: "红队安全研究员", field: "security", place: "远程 / 全球", focus: "攻防对抗 · 基础设施安全", status: "招募中" },
  { kind: "opening", seat: "量子算法研究员", field: "quantum", place: "远程 / 全球", focus: "量子纠错 · 算法设计", status: "招募中" },
  { kind: "opening", seat: "芯片架构工程师", field: "semiconductor", place: "远程 / 全球", focus: "高性能计算芯片 · 封装测试", status: "招募中" },
];
